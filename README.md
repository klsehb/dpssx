...
###  3. Database Proxy
   ...
   Modify the targetDir variable in the main execution entry of taint_analysis.php, input the file path. XAMPP comes with PHP built-in; simply add XAMPP's PHP to the environment variables to run PHP files from the command line.  
   <img width="416" height="74" alt="8a6c52b8816c4acad1516c50ed458c79" src="https://github.com/user-attachments/assets/ddd6e745-1481-499a-9051-56d1b3d2db11" />
